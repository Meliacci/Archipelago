...
def get_ut_color(color: str)->str:
    ...
    if not hasattr(get_ut_color,"utTextColor"):
        get_ut_color.utTextColor = HijackTextColor()
...
class OptionsCreator(ThemedApp):
    base_title: str = "Hijack - Pilot Async Generator"
    ...
    def __init__(self):
        self.title = self.base_title + " " + HIJACK_VERSION
