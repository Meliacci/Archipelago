...
if TYPE_CHECKING:
    from .world import GBAPQuestWorld
...
class GBAPQuestLocation(Location):
    game = "GBAPQuest"
...
def create_all_locations(world: GBAPQuestWorld) -> None:
    create_regular_locations(world)
    create_events(world)


def create_regular_locations(world: GBAPQuestWorld) -> None:
    ...
    bottom_left_chest = GBAPQuestLocation(
    ...
    bottom_right_room.add_locations(bottom_right_room_locations, GBAPQuestLocation)

    top_left_room_locations = get_location_names_with_ids(["Top Left Room Chest"])
    top_left_room.add_locations(top_left_room_locations, GBAPQuestLocation)

    right_room_locations = get_location_names_with_ids(["Right Room Enemy Drop"])
    right_room.add_locations(right_room_locations, GBAPQuestLocation)
    ...
    if world.options.hammer:
        ...
        top_middle_room.add_locations(top_middle_room_locations, GBAPQuestLocation)
    else:
        overworld.add_locations(top_middle_room_locations, GBAPQuestLocation)
    ...
    if world.options.extra_starting_chest:
        ...
        overworld.add_locations(bottom_left_extra_chest, GBAPQuestLocation)


def create_events(world: GBAPQuestWorld) -> None:
    ...
    button_in_top_left_room = GBAPQuestLocation(world.player, "Top Left Room Button", None, top_left_room)
    ...
    button_item = items.GBAPQuestItem("Top Left Room Button Pressed", ItemClassification.progression, None, world.player)
    ...
    final_boss_room.add_event(
        "Final Boss Defeated", "Victory", location_type=GBAPQuestLocation, item_type=items.GBAPQuestItem
    )
