...
def set_all_rules(world: GBAPQuestWorld) -> None:
...
def set_all_entrance_rules(world: GBAPQuestWorld) -> None:
...
def set_all_location_rules(world: GBAPQuestWorld) -> None:
...
def set_completion_condition(world: GBAPQuestWorld) -> None:
