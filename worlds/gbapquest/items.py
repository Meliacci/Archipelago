...
ITEM_NAME_TO_ID = {
    ...
    "Health Upgrade": 5,
    "Confetti Cannon": 6,
    "Math Trap": 7, # This does not Exist in GBAPquest, but keep it
}
...
def get_random_filler_item_name(world: GBAPQuestWorld) -> str:
    # GBAPQuest Only has confetti Cannons as filler
...
def create_item_with_correct_classification(world: GBAPQuestWorld, name: str) -> GBAPQuestItem:
    ...
    return GBAPQuestItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


# With those two helper functions defined, let's now get to actually creating and submitting our itempool.
def create_all_items(world: GBAPQuestWorld) -> None:
